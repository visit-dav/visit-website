...
layout: page
show_meta: false
title: "VisIt 3.3.1 Release"
subheadline: "20 bugfixes, 11 enhancements, 9 development changes"
teaser: "Many fixes and enhancements to the new color table tagging capabilities"
tags:
    - post format
categories:
    - releases
...
* [More details]({{ site.baseurl }}/releases/release-notes-3.3.1)
