...
widget2:
  ...
  text: 'Get the [latest release](./releases-as-tables/#latest) to start visualizing and analyzing your data today. Or, download the <a href="https://github.com/visit-dav/visit/releases/download/v3.5.0/build_visit3_5_0">latest build_visit</a> script to build a custom version. Please <a href="https://github.com/visit-dav/visit/discussions/new">share a comment</a> with us about your experiences with VisIt.'
widget3:
  title: "What's new?"
