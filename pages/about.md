...
architecture for custom database readers, operators and plots as well as the ability
to support multiple different user interfaces.

Following a prototyping effort in
the summer of 2000, an initial version of VisIt was developed and released in
the fall of 2002. Since then, over 140 database readers, 70 operators and 20
plot plugins have been added to the open source code. In addition, commercial,
...
Although the primary driving force behind the original development of
