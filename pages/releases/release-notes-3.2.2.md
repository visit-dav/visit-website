...
* Fixed a bug in the <i>Chombo Users</i> configuration that prevented the macros from being loaded and appearing in the "Macros" window.
...
* A <code>-lang</code> command-line argument was added to start VisIt with a different language translation. For example, use <code>-lang fr</code> to run VisIt with the French translation.
